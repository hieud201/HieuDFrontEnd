...
const BookViewPage: React.FC = () => {
  ...
  useEffect(() => {
    ...
    fetchBookDetails();
  }, [isbn13, session?.token?.accessToken]);
  ...
  return (
    <Container>
      <Row className="mt-4">
        <Col md={4}>
          <img src={book.icons.large} alt={book.title} width='100%' height='auto' className="img-fluid" />
        </Col>
        <Col md={8}>
          <Card className="book-details-card shadow-sm">
            <Card.Body>
              ...
              <div className="book-details">
                ...
                <p>
                  <strong>Total Ratings:</strong> {book.ratings.count}
                </p>
